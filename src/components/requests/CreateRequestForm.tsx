...
const requestSchema = z.object({
  type: z.enum(['representation', 'consultation', 'documentation'], {
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <Select onValueChange={field.onChange} defaultValue={field.value}>
                    ...
                    <SelectContent>
                      <SelectItem value="representation">مرافعة</SelectItem>
                      <SelectItem value="consultation">استشارة</SelectItem>
                      <SelectItem value="documentation">إجراءات مكتبية</SelectItem>
                    </SelectContent>
                  </Select>
                  <FormMessage />
                </FormItem>
            ...
            <Button type="submit" className="w-full" disabled={isLoading}>
              {isLoading ? <Loader2 className="mr-2 h-4 w-4 animate-spin" /> : 'إنشاء الطلب'}
            </Button>
          </form>
        </Form>
      </DialogContent>
