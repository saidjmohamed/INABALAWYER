...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-200 ease-in-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 touch-friendly",
  {
    variants: {
      variant: {
        ...
        gold: "bg-gradient-to-r from-yellow-500 to-yellow-600 text-white shadow hover:from-yellow-600 hover:to-yellow-700 hover:shadow-lg hover:-translate-y-0.5",
      },
      size: {
