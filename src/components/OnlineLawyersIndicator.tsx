      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <Link to="/lawyers" className="fixed bottom-8 right-8 z-50">
            <div className="relative flex items-center justify-center bg-secondary text-secondary-foreground h-16 w-16 rounded-full shadow-lg hover:bg-secondary/90 transition-colors">
